...
givePowerRankXP()
{
	...
	if ( level.scr_power_rank_mode == 2 && !self.powerRanked ) {
		self unlockSpecialAttachments();
		self unlockSpecialCamos();				
	}
  self.powerRanked = true;
...
unlockSpecialAttachments()
{
  ...
  */
  attachmentList[0] = "ak47 reflex;ak74u reflex;m1014 reflex;g3 reflex;g36c reflex;m14 reflex";
	attachmentList[1] = "m16 reflex;m4 reflex;mp5 reflex";
	attachmentList[2] = "skorpion reflex;uzi reflex;winchester1200 reflex;ak47 silencer;ak74u silencer";
	attachmentList[3] = "g3 silencer;g36c silencer;m14 silencer;m16 silencer;m4 silencer;mp5 silencer";
	attachmentList[4] = "skorpion silencer;uzi silencer;ak47 acog;ak74u acog;barrett acog";
	attachmentList[5] = "dragunov acog;g3 acog;g36c acog;m14 acog;m16 acog;m21 acog";
	attachmentList[6] = "m4 acog;m40a3 acog;mp5 acog;remington700 acog";
	attachmentList[7] = "skorpion acog;uzi acog";
	attachmentList[8] = "m1014 grip;winchester1200 grip";
