...
submitUpdate()
{
class_offset = self.cacEdit_classes[self.classesIndex].stat;

self setStat( class_offset + 1, self.cacEdit_primaries[self.primariesIndex].stat );
self setStat( class_offset + 2, self.cacEdit_pattachments[self.pattachmentsIndex].stat );
if ( self.cacEdit_perk2[self.perk2Index].stat != 166 )
{
self setStat( class_offset + 3, self.cacEdit_secondaries[self.secondariesIndex].stat );
self setStat( class_offset + 4, self.cacEdit_sattachments[self.sattachmentsIndex].stat );
}
else
{
self setStat( class_offset + 3, self.cacEdit_primaries[self.primaries2Index].stat );
self setStat( class_offset + 4, self.cacEdit_pattachments[self.pattachments2Index].stat );
}
if ( self.perk1Index != -1 )
self setStat( class_offset + 5, self.cacEdit_perk1[self.perk1Index].stat );
...
self setStat( class_offset + 6, self.cacEdit_perk2[self.perk2Index].stat );
self setStat( class_offset + 7, self.cacEdit_perk3[self.perk3Index].stat );
self setStat( class_offset + 8, self.cacEdit_sgrenades[self.sgrenadesIndex].stat );
self setStat( class_offset + 9, self.cacEdit_camos[self.camosIndex].stat );
...
self addCACClasses( "customclass1", 200 );
self addCACClasses( "customclass2", 210 );
self addCACClasses( "customclass3", 220 );
self addCACClasses( "customclass4", 230 );
self addCACClasses( "customclass5", 240 );
}
...
if ( getdvarx( "weap_allow_assault_m16", "int", 1, 0, 1 ) )
self addCACPrimaries( "assault", 25 );
if ( getdvarx( "weap_allow_assault_ak47", "int", 1, 0, 1 ) )
self addCACPrimaries( "assault", 20 );
if ( getdvarx( "weap_allow_assault_m4", "int", 1, 0, 1 ) )
self addCACPrimaries( "assault", 26 );
if ( getdvarx( "weap_allow_assault_g3", "int", 1, 0, 1 ) )
self addCACPrimaries( "assault", 23 );
if ( getdvarx( "weap_allow_assault_g36c", "int", 1, 0, 1 ) )
self addCACPrimaries( "assault", 24 );
if ( getdvarx( "weap_allow_assault_m14", "int", 1, 0, 1 ) )
self addCACPrimaries( "assault", 21 );
if ( getdvarx( "weap_allow_assault_mp44", "int", 1, 0, 1 ) )
self addCACPrimaries( "assault", 22 );

if ( getdvarx( "weap_allow_specops_mp5", "int", 1, 0, 1 ) )
self addCACPrimaries( "smg", 10 );
if ( getdvarx( "weap_allow_specops_skorpion", "int", 1, 0, 1 ) )
self addCACPrimaries( "smg", 11 );
if ( getdvarx( "weap_allow_specops_uzi", "int", 1, 0, 1 ) )
self addCACPrimaries( "smg", 12 );
if ( getdvarx( "weap_allow_specops_ak74u", "int", 1, 0, 1 ) )
self addCACPrimaries( "smg", 13 );
if ( getdvarx( "weap_allow_specops_p90", "int", 1, 0, 1 ) )
self addCACPrimaries( "smg", 14 );

if ( getdvarx( "weap_allow_heavygunner_saw", "int", 1, 0, 1 ) )
self addCACPrimaries( "heavy", 81 );
if ( getdvarx( "weap_allow_heavygunner_rpd", "int", 1, 0, 1 ) )
self addCACPrimaries( "heavy", 80 );
if ( getdvarx( "weap_allow_heavygunner_m60e4", "int", 1, 0, 1 ) )
self addCACPrimaries( "heavy", 82 );

if ( getdvarx( "weap_allow_demolitions_winchester1200", "int", 1, 0, 1 ) )
self addCACPrimaries( "shotgun", 71 );
if ( getdvarx( "weap_allow_demolitions_m1014", "int", 1, 0, 1 ) )
self addCACPrimaries( "shotgun", 70 );

if ( getdvarx( "weap_allow_sniper_m40a3", "int", 1, 0, 1 ) )
self addCACPrimaries( "sniper", 61 );
if ( getdvarx( "weap_allow_sniper_m21", "int", 1, 0, 1 ) )
self addCACPrimaries( "sniper", 65 );
if ( getdvarx( "weap_allow_sniper_dragunov", "int", 1, 0, 1 ) )
self addCACPrimaries( "sniper", 60 );
if ( getdvarx( "weap_allow_sniper_remington700", "int", 1, 0, 1 ) )
self addCACPrimaries( "sniper", 64 );
if ( getdvarx( "weap_allow_sniper_barrett", "int", 1, 0, 1 ) )
self addCACPrimaries( "sniper", 62 );
}

addPrimaryAttachments()
{

self addCACPrimaryAttachments( 0 );
if ( getdvarx( "attach_allow_silencer", "int", 1, 0, 1 ) )
self addCACPrimaryAttachments( 3 );
if ( getdvarx( "attach_allow_reflex", "int", 1, 0, 1 ) )
self addCACPrimaryAttachments( 2 );
if ( getdvarx( "attach_allow_acog", "int", 1, 0, 1 ) )
self addCACPrimaryAttachments( 1 );
if ( getdvarx( "attach_allow_grip", "int", 1, 0, 1 ) )
self addCACPrimaryAttachments( 4 );
if ( getdvarx( "attach_allow_assault_gl", "int", 1, 0, 1 ) )
...
if ( getdvarx( "weap_allow_beretta", "int", 1, 0, 1 ) )
self addCACSecondaries( 0 );
if ( getdvarx( "weap_allow_usp", "int", 1, 0, 1 ) )
self addCACSecondaries( 2 );
if ( getdvarx( "weap_allow_colt45", "int", 1, 0, 1 ) )
self addCACSecondaries( 1 );
if ( getdvarx( "weap_allow_deserteagle", "int", 1, 0, 1 ) )
self addCACSecondaries( 3 );
if ( getdvarx( "weap_allow_deserteaglegold", "int", 1, 0, 1 ) )
self addCACSecondaries( 4 );
}

addSecondaryAttachments()
{

self addCACSecondaryAttachments( 0 );
self addCACSecondaryAttachments( 3 );
}
